...
python3 /usr/bin/genRSS.py -e "mp3,ogg,aac,m4a" -d did -H https://pod.crabdance.com -t "Desert-Island-Discs" -p "Radio" -r -o did.rss

python3 /usr/bin/genRSS.py -e "mp3,ogg,aac,m4a" -d fnc -H https://pod.crabdance.com -t "Friday-Night-Comedy" -p "Radio" -r -o fnc.rss

python3 /usr/bin/genRSS.py -e "mp3,ogg,aac,m4a" -d ftw -H https://pod.crabdance.com -t "The-First-Time-With" -p "Radio" -r -o ftw.rss
